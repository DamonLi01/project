...
) ENGINE=MyISAM AUTO_INCREMENT=130 DEFAULT CHARSET=utf8 COMMENT='//项目信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fanwe_deal_item` (
  ...
  KEY `deal_id` (`deal_id`),
  KEY `price` (`price`)
) ENGINE=MyISAM AUTO_INCREMENT=85 DEFAULT CHARSET=utf8 COMMENT='// 项目回报';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fanwe_user` (
  ...
  KEY `is_effect` (`is_effect`)
) ENGINE=MyISAM AUTO_INCREMENT=75 DEFAULT CHARSET=utf8 COMMENT='//用户信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-06-22 13:32:11
